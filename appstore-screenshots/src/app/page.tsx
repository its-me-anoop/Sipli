...
/* ═══════════════════════════════════════════════════════
   APPLE WATCH SLIDES (real simulator screenshots)
   ═══════════════════════════════════════════════════════ */

function WatchSlide1() {
  return (
    <div style={{ width: WW, height: WH, overflow: "hidden", background: "#000" }}>
      <img src="/screenshots/watch/dashboard.png" alt="Sipli Watch — Dashboard"
...
function WatchSlide2() {
  return (
    <div style={{ width: WW, height: WH, overflow: "hidden", background: "#000" }}>
      <img src="/screenshots/watch/quick-add.png" alt="Sipli Watch — Quick Add"
        style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "top", display: "block" }}
        draggable={false} />
    </div>
  );
...
function WatchSlide3() {
  return (
    <div style={{ width: WW, height: WH, overflow: "hidden", background: "#000" }}>
      <img src="/screenshots/watch/beverage-picker.png" alt="Sipli Watch — Beverage Picker"
        style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "top", display: "block" }}
        draggable={false} />
    </div>
  );
...
function WatchSlide4() {
  return (
    <div style={{ width: WW, height: WH, overflow: "hidden", background: "#000" }}>
      <img src="/screenshots/watch/watch-face.png" alt="Sipli Watch — Watch Face"
        style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "top", display: "block" }}
        draggable={false} />
    </div>
  );
...
const WATCH_SCREENSHOTS: ScreenshotEntry[] = [
  ...
  { name: "watch-beverage-picker", component: WatchSlide3 },
  { name: "watch-face", component: WatchSlide4 },
];
