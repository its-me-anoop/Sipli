...
- Provide accurate profile information (weight, activity level) for goal calculations.
...
- Accuracy of weather data or HealthKit integration.

## 9. Limitation of Liability

To the maximum extent permitted by applicable law, Anoop Jose shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of data, health outcomes, profits, or goodwill arising from your use of or inability to use the app.
...
We reserve the right to suspend or terminate your access to the app if you violate these Terms. You may stop using the app at any time by uninstalling it and canceling any active subscription.

## 12. Changes to Terms

We may update these Terms from time to time. The "Last updated" date at the top indicates when changes were last made. Continued use of the app after changes constitutes acceptance of the updated Terms.
