...
#ifndef SIPLIWATCH_SWIFT_H
#define SIPLIWATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SipliWatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10SipliWatch16WatchAppDelegate")
@interface WatchAppDelegate : NSObject <UNUserNotificationCenterDelegate, WKApplicationDelegate>
...
/// • <code>NewWatchEntry</code>         — a new HydrationEntry logged on Watch
/// • <code>DeletedWatchEntryID</code>   — UUID string of an entry deleted on Watch
/// • <code>SyncRequest</code>           — ask iPhone to push its current full state
/// Incoming (iPhone → Watch):
/// • <code>PersistedStateBlob</code>    — full authoritative PersistedState from iPhone
SWIFT_CLASS("_TtC10SipliWatch19WatchSessionManager")
